...
; // **PASTIKAN INI DIGANTI DENGAN API KEY ANDA!**
    ...
    try {
        const response = await fetch(url, {
            ...
            headers: {
                ...
                'Authorization': `Bearer ${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
}`
            },
            body: JSON.stringify({
