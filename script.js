...
async function fetchAIQuestions(category, level, difficulty) {
    ...
    Contoh:
    Buatlah 5 soal kuis ${category} tingkat ${level} dengan tingkat kesulitan ${difficulty}. Berikan 4 pilihan jawaban (A, B, C, D) dengan deskripsi singkat untuk setiap pilihan. Tandai jawaban yang benar. Output dalam format JSON:`;
    
    /**********************************************************************************
     * *
     * !!!  PERHATIAN !!!                                   *
     * *
     * PASTIKAN ANDA MENGGANTI 'YOUR_API_KEY' DI BAWAH INI DENGAN API KEY ANDA YANG       *
     * SEBENARNYA. JANGAN BIARKAN SEPERTI INI, ATAU KODE TIDAK AKAN BERFUNGSI!         *
     * JANGAN SIMPAN API KEY ANDA DI FRONTEND UNTUK APLIKASI PRODUKSI!                 *
     * *
     **********************************************************************************/
    
    const apiKey = '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
';  
...
function endQuiz() {
    ...
    let resultMessage = `Skor Anda: ${score} dari ${questions.length} (${percentage.toFixed(2)}%)`;
