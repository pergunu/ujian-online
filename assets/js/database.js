...
function initDatabase() {
    ...
    if (!localStorage.getItem('infoText')) {
        localStorage.setItem('infoText', 'Informasi penting akan ditampilkan di sini oleh admin.');
    }
    if (!localStorage.getItem('examInfoText')) {
        localStorage.setItem('examInfoText', 'Informasi ujian akan ditampilkan di sini oleh admin.');
    }
    ...
    if (!localStorage.getItem('motivationMessages')) {
        localStorage.setItem('motivationMessages', JSON.stringify([
            ...
            'Hasil yang cukup baik. Tingkatkan lagi pemahaman Anda untuk hasil yang lebih maksimal.',
    ...
    if (!localStorage.getItem('questionPoints')) {
    ...
    if (!localStorage.getItem('examStatus')) {
        localStorage.setItem('examStatus', JSON.stringify({
            'AGAMA': true,
            'PPKN': true,
            'SEJARAH': true,
            'IPA': true,
